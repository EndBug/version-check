...
const packageFileName = core_1.default.getInput('file-name') || 'package.json', dir = process.env.GITHUB_WORKSPACE || '/github/workspace', eventFile = process.env.GITHUB_EVENT_PATH || '/github/workflow/event.json';
function main() {
...
function checkCommits(commits, version) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (core_1.default.getInput('diff-search')) {
...
function checkDiff(sha, version) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log(versionLines.added.match(semver_regex_1.default()));
...
function setOutput(name, value) {
    return core_1.default.setOutput(name, `${value}`);
}
